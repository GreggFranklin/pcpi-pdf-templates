...
$val = function ( $id, $default = "" ) use ( &$form_data, &$entry, &$form, &$pcpi_source_entry, &$pcpi_source_form ) {
	...
	// IMPORTANT: If a sub-input was requested (e.g. "10.1") and it's empty/missing,
	// do NOT fall back to GF display formatting (it can return whole-field HTML like <br> + "Map It").
